#' Three-level occupancy model for multiple species
#'
...
#' species with a single site-occupancy probability. The model primarily exists
#' as a building block for more complicated models.
#'
...
#'}
occ_3lvl_multispp <- function(stan_data,
                              n_chains = 2,
                              n_parallel_chains = 2,
                              n_threads_per_chain = 4,
                              n_refresh = 100,
  ...
  stan_file <- system.file("./stan_models/tutorial/occ_3lvl_multispp.stan",
                           package = "occstanhm")
